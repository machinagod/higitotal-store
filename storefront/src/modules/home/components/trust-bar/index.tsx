    ...
    <div className="grid grid-cols-2 overflow-hidden rounded-large border border-hairline bg-white small:grid-cols-4">
      {ITEMS.map((item, i) => {
        ...
        return (
          ...
          >
            <span className="flex h-9 w-9 flex-none items-center justify-center rounded-[12px] bg-[#eaf7fe] small:h-[42px] small:w-[42px]">
              <span className="h-2 w-2 rounded-full bg-brand-cyan shadow-[0_0_0_4px_rgba(0,173,239,0.18)]" />
            </span>
            <div>
