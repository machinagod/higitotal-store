...
const COMPETITORS: Array<{
  ...
  { handle: "progelcone-pt", name: "Progelcone (PT)", base_url: "https://www.progelcone.pt", scraper_key: "generic-jsonld" },
  ...
  { handle: "lusohigin-pt", name: "Lusohigin (PT)", base_url: "https://www.lusohigin.pt", scraper_key: "generic-jsonld" },
  ...
  { handle: "prismasl-es", name: "Prisma SL (ES)", base_url: "https://catalogo.prismasl.com", scraper_key: "generic-jsonld" },
  { handle: "pedrosa-es", name: "Pedrosa (ES)", base_url: "https://catalogo.pedrosa.net", scraper_key: "generic-jsonld" },
